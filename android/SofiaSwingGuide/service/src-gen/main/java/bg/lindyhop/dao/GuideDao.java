 ...
 * DAO for table "GUIDE".
*/
public class GuideDao extends AbstractDao<Guide, Void> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Guide entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(Guide entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(Guide entity) {
        return null;
    }
